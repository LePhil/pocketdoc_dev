  ...
  "pascalprecht.translate"
	...
	function($routeProvider, $locationProvider, $httpProvider, $mdThemingProvider, $translateProvider) {
		...
		$translateProvider.translations('de', {
			...
			header_furtherInformation: "Mehr Infos",
			...
			reg_save: "Speichern",
			reg_AGBs: "AGBs",
			reg_AGBs_text: "Ich stimme den AGBs zu:",
			header_terms: "AGB",
			...
			common_newWindow: "Neues Fenster",
		...
		$translateProvider.translations('en', {
			...
			header_account: "Account",
			header_furtherInformation: "More Info",
			header_login_email: "E-Mail",
			...
			reg_back: "Back",
			reg_save: "Save",
			reg_AGBs: "Terms and Conditions",
			reg_AGBs_text: "I accept the Terms and Conditions:",
			header_terms: "Terms",
